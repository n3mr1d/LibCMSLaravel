...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    {{ $slot }}
        ...
        <div class="fixed bottom-4 right-4 z-50">
            <flux:button x-data x-on:click="$flux.dark = !$flux.dark" class="bg-gray-700 relative overflow-hidden">
                <span
                ...
                <span
                    ...
                    class="absolute inset-0 flex items-center justify-center"
                >
                    <flux:icon.moon variant="mini" class="text-zinc-500 font-semibold dark:text-white" />
                </span>
